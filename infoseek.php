...
<input type="submit" id="lo" name="lout" value="logout">
	  ...
	  <div class="article">
		  ...
		  <br>
          <ul class="sb_menu">
	<li><a href="#"><strong>manage users</strong></a></li>
	<li><a href="#"><strong>place announcements</strong></a></li>
	<li style="color:white;"><strong>upload sample resume</strong></li>
	<li><input type="file"></li>
	<li><a href="#"><strong>edit website</strong></a></li>
		  </ul>
        </div>
      </div>
